...
This repository documents architectural patterns and infrastructure flows used in the design of a cloud-native ML data platform.

It is not the full application codebase. Instead, it highlights system design decisions, model lifecycle orchestration, and distributed processing strategies implemented in a production-style environment.
